...
class Collect(Component):
    ...
    def fit(self, data: DataFrame) -> Self:
        self.component.fit(data.lazy())
        return self

    @override
    def execute(self, data: DataFrame) -> DataFrame:
        return self.component.execute(data.lazy()).collect(**self.collect_kwargs)

    @override
    def fit_execute(self, data: DataFrame) -> DataFrame:
        return self.component.fit_execute(data.lazy()).collect(**self.collect_kwargs)
