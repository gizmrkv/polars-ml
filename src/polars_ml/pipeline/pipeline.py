...
class Pipeline(Transformer, PipelineMixin):
    ...
    def corr(self, label: str | None = None, **kwargs: Any) -> Self:
        return self.pipe(GetAttr("corr", None, label=label, **kwargs))
    ...
    def merge_sorted(self, other: pl.DataFrame | Transformer, key: str) -> Self:
    ...
    def set_sorted(
        self, column: str, descending: bool = False, nulls_last: bool = False
    ) -> Self:
        return self.pipe(
            GetAttr(
                "set_sorted", None, column, descending=descending, nulls_last=nulls_last
            )
        )
    ...
    def vstack(self, other: pl.DataFrame | Transformer, in_place: bool = False) -> Self:
