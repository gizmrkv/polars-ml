...
class PipelineMixin(Transformer):
    @abstractmethod
    def pipe(self, step: Transformer) -> Self: ...

    # --- START INSERTION MARKER IN PipelineMixin
    ...
    # --- END INSERTION MARKER IN PipelineMixin

    # --- START INSERTION MARKER IN Unified IO PipelineMixin
    ...
    # --- END INSERTION MARKER IN Unified IO PipelineMixin
